Feature: Todo
    ...
    @javascript
    Scenario: Resizing one column
        Given I am on the home page
        And   the width of the column Info is 100px
        When  I resize the column Info 200px to the right
        Then  the width of the column Info must be at least 280px #Takes into account the worst case of pixel ajustments
